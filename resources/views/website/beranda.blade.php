<x-main-layout>
    ...
    <div class="container-fluid bg-timeline shadow">
        <div class="container">
            <div class="row ">
                <div class="col-lg row-bg mt-5 mb-5">
                    <div class="row example-centered mt-4 justify-content-center">
                        <div class="col-md-12 example-title text-center mt-2">
                            <h2>Sejarah</h2>
                            ...
                            <ul class="timeline timeline-centered">
                                <li class="timeline-item">
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        <p>Nullam vel sem. Nullam vel sem. Integer ante arcu, accumsan a, consectetuer
                                            eget,
                                            posuere ut,
                                            mauris. Donec orci lectus, aliquam ut, faucibus non, euismod id, nulla.
                                            Donec
                                            vitae sapien
                                            ut
                                            libero venenatis faucibus. ullam dictum felis
